...
{
    // TODO: voronoi
    // TODO: slightly shift vertices 
    switch (type) {
        case MaterialTypeRock:
            return splitIntoSquares(polygon, CELL_SIZE);
        case MaterialTypeDirt:
            return splitIntoHexagons(polygon, CELL_SIZE);
        case MaterialTypeCrystalRed:
            return splitIntoTriangles(polygon, CELL_SIZE);
        case MaterialTypeCrystalGreen:
            return splitIntoTriangles(polygon, CELL_SIZE);
...
std::vector<Polygon> Material::splitIntoHexagons(Polygon polygon, float cellSize)
{
    std::vector<Polygon> source;
    source.push_back(polygon);
