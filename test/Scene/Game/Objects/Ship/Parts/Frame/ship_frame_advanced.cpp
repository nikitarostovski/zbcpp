...
b2AABB ShipFrameAdvanced::getInitialAABB()
{
    b2AABB result;
...
b2Body* ShipFrameAdvanced::createBody(b2World *world)
{
    b2BodyDef bodyDef;
...
void ShipFrameAdvanced::receiveCollision(BodyEntity *entity, float impulse)
{
